...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($email_err) && empty($password_err)) {
        ...
        $sql = "SELECT id, email, password, first_name, last_name, user_type FROM users WHERE email = ?";
        ...
        if($stmt = $conn->prepare($sql)) {
            ...
            if($stmt->execute()) {
                ...
                if($stmt->num_rows == 1) {                    
                    ...
                    $stmt->bind_result($id, $email, $hashed_password, $first_name, $last_name, $user_type);
                    if($stmt->fetch()) {
